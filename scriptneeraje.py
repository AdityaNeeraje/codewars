...
def ActPirate(pirate):
    global pirate_pos, assassins, gunpowder, rum, wood, possible_positions, destinations_for_actors, destination_visits, pirates, reached_end
    ...
    if curr_frame > (dimensionX*dimensionY)/3:
        # print("OVER")
        pass
    if id in assassins and pirate.getCurrentFrame() < (dimensionX*dimensionY)/3:
    ...
    if curr_frame < ((dimensionY+dimensionX)*3)//2 and frame < dimensionY+dimensionX-2:
        if id%2 == 0:
